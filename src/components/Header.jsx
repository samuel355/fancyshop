                    ...
                    isMenu && (
                        <motion.div 
                            ...
                            <ul
                                ...
                                <li className='px-4 py-2 text-base text-textColor hover:text-headingColor duration-100 hover:bg-slate-100 transition-all ease-in-out hover: cursor-pointer'>Services</li>
