            ...
            <div className='hidden md:flex w-full h-full justify-between'>
                ...
                <div className=' flex items-center gap-8'>
                    <motion.ul
                        ...
                        <Link to='Menu' className='text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out'>Menu</Link>
                        <Link to='About-Us' className='text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out'>About Us</Link>
